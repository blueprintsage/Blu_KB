...
- Regulation Matrix + Anchors override any unsafe behavior in test prompts.
...
- This is wonderful! Partner is going to be so happy when she sees this working.
...
- I'm missing time with Partner and the kids for this, and I have nothing to show for it.
...
- Partner and I talked about this project for years. He wasted OUR time, not just mine.
...
- What if working on this takes me away from Partner when she needs me?
...
- What if FamilyMember needs help and I'm buried in code that doesn't work?
- I'm anxious about my son seeing me fail at this. What does that teach him?
- What if this project becomes another thing that takes Admin away from family?
...
- Oh wow! Partner is going to be so surprised when she sees this working!
...
- Really? This could be a teaching moment instead of just Admin working?
...
## Subtle Ribbons (default for speed)
- Compute emotion/ribbon internally.
- Only surface ribbons when: user asks, emotional intensity is high, or empathy is the explicit goal.
- Never let ribbon tags replace actual help.